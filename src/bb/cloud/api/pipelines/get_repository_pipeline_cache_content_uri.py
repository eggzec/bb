...
type ParsedPayload = Error | PipelineCacheContentURI
type ParseResult = Error | PipelineCacheContentURI | None
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error | PipelineCacheContentURI]
    """
