...
type ParsedPayload = Error | PaginatedPipelineSchedule
type ParseResult = Error | PaginatedPipelineSchedule | None
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error | PaginatedPipelineSchedule]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | PaginatedPipelineSchedule
    """
