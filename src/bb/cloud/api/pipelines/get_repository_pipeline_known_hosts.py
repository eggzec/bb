...
type ParsedPayload = Error | PaginatedPipelineKnownHosts
type ParseResult = Error | PaginatedPipelineKnownHosts | None
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error | PaginatedPipelineKnownHosts]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | PaginatedPipelineKnownHosts
    """
