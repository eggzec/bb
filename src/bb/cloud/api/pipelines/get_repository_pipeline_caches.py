...
type ParsedPayload = Error | PaginatedPipelineCache
type ParseResult = Error | PaginatedPipelineCache | None
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error | PaginatedPipelineCache]
    """
