...
type ParsedPayload = Error | PullrequestCommentTask
type ParseResult = Error | PullrequestCommentTask | None


def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ParseResult:
    if response.status_code == 200:
        response_200 = PullrequestCommentTask.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        pull_request_id (int):
        task_id (int):
        body (PullRequestTaskUpdate): A pullrequest task update
    ...
    Returns:
        Response[Error | PullrequestCommentTask]
    """
