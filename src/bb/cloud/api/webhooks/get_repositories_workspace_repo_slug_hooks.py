...
type ParsedPayload = Error | PaginatedWebhookSubscriptions
type ParseResult = Error | PaginatedWebhookSubscriptions | None
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error | PaginatedWebhookSubscriptions]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Error | PaginatedWebhookSubscriptions
    """
