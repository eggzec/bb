...
type ParsedPayload = Error | PaginatedIssueComments
type ParseResult = Error | PaginatedIssueComments | None
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Error | PaginatedIssueComments]
    """
