...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/user/workspaces/{workspace}/permission".format(
...
type ParsedPayload = Error | WorkspaceMembership
type ParseResult = Error | WorkspaceMembership | None


def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ParseResult:
    if response.status_code == 200:
        response_200 = WorkspaceMembership.from_dict(response.json())
...
def sync_detailed(
    ...
    * `member`
    ...
    Returns:
        Response[Error | WorkspaceMembership]
    """
