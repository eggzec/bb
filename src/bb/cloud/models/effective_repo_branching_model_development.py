...
T = TypeVar("T", bound="EffectiveRepoBranchingModelDevelopment")


@_attrs_define
class EffectiveRepoBranchingModelDevelopment:
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effective_repo_branching_model_development = cls(
            name=name,
            use_mainbranch=use_mainbranch,
            branch=branch,
        )

        return effective_repo_branching_model_development
