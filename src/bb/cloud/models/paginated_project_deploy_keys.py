...
T = TypeVar("T", bound="PaginatedProjectDeployKeys")
...
class PaginatedProjectDeployKeys:
    ...
    values: list[ProjectDeployKey] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = ProjectDeployKey.from_dict(values_item_data)

                values.append(values_item)

        paginated_project_deploy_keys = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_project_deploy_keys
