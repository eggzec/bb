...
if TYPE_CHECKING:
    from ..models.default_reviewer_and_type import DefaultReviewerAndType


T = TypeVar("T", bound="PaginatedDefaultReviewerAndType")
...
class PaginatedDefaultReviewerAndType:
    ...
    values: list[DefaultReviewerAndType] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = DefaultReviewerAndType.from_dict(values_item_data)

                values.append(values_item)

        paginated_default_reviewer_and_type = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_default_reviewer_and_type
