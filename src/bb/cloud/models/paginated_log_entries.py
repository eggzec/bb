...
T = TypeVar("T", bound="PaginatedLogEntries")
...
class PaginatedLogEntries:
    ...
    values: list[IssueChange] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = IssueChange.from_dict(values_item_data)

                values.append(values_item)

        paginated_log_entries = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
