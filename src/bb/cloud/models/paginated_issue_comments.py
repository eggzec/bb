...
T = TypeVar("T", bound="PaginatedIssueComments")
...
class PaginatedIssueComments:
    ...
    values: list[IssueComment] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = IssueComment.from_dict(values_item_data)

                values.append(values_item)

        paginated_issue_comments = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_issue_comments
