...
T = TypeVar("T", bound="PaginatedProjectGroupPermissions")


@_attrs_define
class PaginatedProjectGroupPermissions:
    ...
    values: list[ProjectGroupPermission] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = ProjectGroupPermission.from_dict(values_item_data)

                values.append(values_item)

        paginated_project_group_permissions = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_project_group_permissions
