...
if TYPE_CHECKING:
    ...
    from ..models.comment_resolution import CommentResolution
    from ..models.pullrequest import Pullrequest


T = TypeVar("T", bound="PullrequestComment")
...
class PullrequestComment:
    ...
    pullrequest: Pullrequest | Unset = UNSET
    resolution: CommentResolution | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        pullrequest: dict[str, Any] | Unset = UNSET
        if not isinstance(self.pullrequest, Unset):
            pullrequest = self.pullrequest.to_dict()
        ...
        if pullrequest is not UNSET:
            field_dict["pullrequest"] = pullrequest
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _pullrequest = d.pop("pullrequest", UNSET)
        pullrequest: Pullrequest | Unset
        if isinstance(_pullrequest, Unset):
            pullrequest = UNSET
        else:
            pullrequest = Pullrequest.from_dict(_pullrequest)

        _resolution = d.pop("resolution", UNSET)
        resolution: CommentResolution | Unset
        if isinstance(_resolution, Unset):
            resolution = UNSET
        else:
            resolution = CommentResolution.from_dict(_resolution)

        pending = d.pop("pending", UNSET)

        pullrequest_comment = cls(
            type_=type_,
            id=id,
        ...
        pullrequest_comment.additional_properties = d
