...
if TYPE_CHECKING:
    from ..models.repository_permission import RepositoryPermission


T = TypeVar("T", bound="PaginatedRepositoryPermissions")
...
class PaginatedRepositoryPermissions:
    ...
    values: list[RepositoryPermission] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RepositoryPermission.from_dict(values_item_data)

                values.append(values_item)

        paginated_repository_permissions = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_repository_permissions
