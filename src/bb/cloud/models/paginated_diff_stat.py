...
if TYPE_CHECKING:
    from ..models.diff_stat import DiffStat


T = TypeVar("T", bound="PaginatedDiffStat")


@_attrs_define
class PaginatedDiffStat:
    ...
    """ Current number of objects on the existing page. The default value is 500 with 5000 being the maximum allowed
    value. """
    ...
    values: list[DiffStat] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = DiffStat.from_dict(values_item_data)

                values.append(values_item)

        paginated_diff_stat = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
