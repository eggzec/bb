...
T = TypeVar("T", bound="PaginatedCommitStatuses")
...
class PaginatedCommitStatuses:
    ...
    values: list[Commitstatus] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = Commitstatus.from_dict(values_item_data)

                values.append(values_item)

        paginated_commit_statuses = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_commit_statuses
