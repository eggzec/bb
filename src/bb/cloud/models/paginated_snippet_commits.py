...
T = TypeVar("T", bound="PaginatedSnippetCommits")


@_attrs_define
class PaginatedSnippetCommits:
    ...
    values: list[SnippetCommit] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = SnippetCommit.from_dict(values_item_data)

                values.append(values_item)

        paginated_snippet_commits = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_snippet_commits
