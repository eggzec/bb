...
T = TypeVar("T", bound="EffectiveRepoBranchingModelProduction")


@_attrs_define
class EffectiveRepoBranchingModelProduction:
    name: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effective_repo_branching_model_production = cls(
            name=name,
            use_mainbranch=use_mainbranch,
            branch=branch,
        )

        return effective_repo_branching_model_production
