...
if TYPE_CHECKING:
    from ..models.workspace_access import WorkspaceAccess


T = TypeVar("T", bound="PaginatedWorkspacePermissions")


@_attrs_define
class PaginatedWorkspacePermissions:
    ...
    values: list[WorkspaceAccess] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = WorkspaceAccess.from_dict(values_item_data)

                values.append(values_item)

        paginated_workspace_permissions = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_workspace_permissions
