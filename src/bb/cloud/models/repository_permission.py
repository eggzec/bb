...
from ..models.repository_permission_permission import RepositoryPermissionPermission
...
T = TypeVar("T", bound="RepositoryPermission")
...
class RepositoryPermission:
    ...
    type_: str
    permission: RepositoryPermissionPermission | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permission: RepositoryPermissionPermission | Unset
        if isinstance(_permission, Unset):
            permission = UNSET
        else:
            permission = RepositoryPermissionPermission(_permission)
        ...
        repository_permission.additional_properties = d
