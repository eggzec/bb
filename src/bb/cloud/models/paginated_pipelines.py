...
T = TypeVar("T", bound="PaginatedPipelines")
...
class PaginatedPipelines:
    ...
    values: list[Pipeline] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = Pipeline.from_dict(values_item_data)
        ...
        paginated_pipelines.additional_properties = d
        return paginated_pipelines
