...
T = TypeVar("T", bound="PaginatedGPGUserKeys")


@_attrs_define
class PaginatedGPGUserKeys:
    ...
    values: list[GPGAccountKey] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = GPGAccountKey.from_dict(values_item_data)

                values.append(values_item)

        paginated_gpg_user_keys = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_gpg_user_keys
