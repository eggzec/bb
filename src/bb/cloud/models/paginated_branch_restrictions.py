...
T = TypeVar("T", bound="PaginatedBranchRestrictions")
...
class PaginatedBranchRestrictions:
    ...
    values: list[Branchrestriction] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = Branchrestriction.from_dict(values_item_data)

                values.append(values_item)

        paginated_branch_restrictions = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
        ...
        return paginated_branch_restrictions
