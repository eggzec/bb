...
T = TypeVar("T", bound="PaginatedRunners")


@_attrs_define
class PaginatedRunners:
    """A paged list of runners."""

    page: int | Unset = UNSET
    """ Page number of the current results. This is an optional element that is not provided in all responses. """
    values: list[PipelineRunner] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = PipelineRunner.from_dict(values_item_data)
        ...
        paginated_runners.additional_properties = d
        return paginated_runners
