...
T = TypeVar("T", bound="PaginatedTreeEntry")


@_attrs_define
class PaginatedTreeEntry:
    ...
    values: list[TreeEntry] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = TreeEntry.from_dict(values_item_data)

                values.append(values_item)

        paginated_tree_entry = cls(
            size=size,
            page=page,
            pagelen=pagelen,
            next_=next_,
