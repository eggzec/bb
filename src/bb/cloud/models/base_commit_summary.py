...
from ..models.base_commit_summary_markup import BaseCommitSummaryMarkup
from ..types import UNSET, Unset

T = TypeVar("T", bound="BaseCommitSummary")
...
class BaseCommitSummary:
    ...
    markup: BaseCommitSummaryMarkup | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        markup: BaseCommitSummaryMarkup | Unset
        if isinstance(_markup, Unset):
            markup = UNSET
        else:
            markup = BaseCommitSummaryMarkup(_markup)

        html = d.pop("html", UNSET)

        base_commit_summary = cls(
            raw=raw,
            markup=markup,
            html=html,
        )

        return base_commit_summary
