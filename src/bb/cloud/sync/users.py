...
def gpg_keys(client: BBClient, selected_user: str, *, pagelen: int = 25) -> list[GpgAccountKey]:
    """Sync version of :func:`~bb.cloud.sdk.users.gpg_keys`."""
    return asyncio.run(_async.gpg_keys(client, selected_user, pagelen=pagelen))


def get_gpg_key(client: BBClient, selected_user: str, fingerprint: str) -> GpgAccountKey | None:
