...
def create_linker_value(client: BBClient, linker_key: str, *, body: Unset = UNSET) -> Any | None:
...
def set_linker_values(client: BBClient, linker_key: str, *, body: Unset = UNSET) -> Any | None:
