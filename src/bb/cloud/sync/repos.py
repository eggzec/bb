...
def list_all(
    ...
    *,
    ...
    """Sync version of :func:`~bb.cloud.sdk.repos.list_all`."""
    return asyncio.run(_async.list_all(client, after=after, role=role, q=q, sort=sort, pagelen=pagelen))


def get(client: BBClient, workspace: str, repo_slug: str) -> Repository | None:
...
def forks(client: BBClient, workspace: str, repo_slug: str) -> list[Repository]:
    """Sync version of :func:`~bb.cloud.sdk.repos.forks`."""
    return asyncio.run(_async.forks(client, workspace, repo_slug))


def watchers(client: BBClient, workspace: str, repo_slug: str) -> list[Repository]:
...
def group_permissions(client: BBClient, workspace: str, repo_slug: str, *, pagelen: int = 25) -> list[Any]:
...
def user_permissions(client: BBClient, workspace: str, repo_slug: str, *, pagelen: int = 25) -> list[Any]:
...
def workspace_user_permissions(client: BBClient, workspace: str, *, pagelen: int = 25) -> list[Any]:
