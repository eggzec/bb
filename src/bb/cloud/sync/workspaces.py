...
def repo_permissions(client: BBClient, workspace: str, *, pagelen: int = 25) -> list[Any]:
...
def get_repo_permission(client: BBClient, workspace: str, repo_slug: str) -> Any | None:
...
def user_prs(client: BBClient, workspace: str, selected_user: str, *, pagelen: int = 25) -> list[Any]:
...
def my_permission(client: BBClient, workspace: str) -> Any | None:
