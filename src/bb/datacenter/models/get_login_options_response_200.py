...
T = TypeVar("T", bound="GetLoginOptionsResponse200")


@_attrs_define
class GetLoginOptionsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_login_options_response_200 = cls(
        ...
        get_login_options_response_200.additional_properties = d
        return get_login_options_response_200
