...
T = TypeVar("T", bound="RestConflictTheirChangePath")


@_attrs_define
class RestConflictTheirChangePath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_conflict_their_change_path = cls(
        ...
        rest_conflict_their_change_path.additional_properties = d
        return rest_conflict_their_change_path
