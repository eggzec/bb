...
if TYPE_CHECKING:
    ...
    from ..models.rest_restriction_request_matcher import RestRestrictionRequestMatcher
    from ..models.rest_restriction_request_scope import RestRestrictionRequestScope
    from ..models.rest_ssh_access_key import RestSshAccessKey


T = TypeVar("T", bound="RestRestrictionRequest")


@_attrs_define
class RestRestrictionRequest:
    ...
    id: int | Unset = UNSET
    matcher: RestRestrictionRequestMatcher | Unset = UNSET
    scope: RestRestrictionRequestScope | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        access_key_ids = cast(list[int], d.pop("accessKeyIds"))

        group_names = cast(list[str], d.pop("groupNames"))

        user_slugs = cast(list[str], d.pop("userSlugs"))
        ...
        matcher: RestRestrictionRequestMatcher | Unset
        if isinstance(_matcher, Unset):
            matcher = UNSET
        else:
            matcher = RestRestrictionRequestMatcher.from_dict(_matcher)

        _scope = d.pop("scope", UNSET)
        scope: RestRestrictionRequestScope | Unset
        if isinstance(_scope, Unset):
            scope = UNSET
        else:
            scope = RestRestrictionRequestScope.from_dict(_scope)
        ...
        rest_restriction_request.additional_properties = d
        return rest_restriction_request
