...
if TYPE_CHECKING:
    from ..models.example_json_last_modified_callback_readme_md_author import (
        ExampleJsonLastModifiedCallbackReadmeMdAuthor,
    )
    from ..models.example_json_last_modified_callback_readme_md_committer import (
        ExampleJsonLastModifiedCallbackReadmeMdCommitter,
    )
    from ..models.rest_minimal_commit import RestMinimalCommit


T = TypeVar("T", bound="ExampleJsonLastModifiedCallbackReadmeMd")


@_attrs_define
class ExampleJsonLastModifiedCallbackReadmeMd:
    author: ExampleJsonLastModifiedCallbackReadmeMdAuthor | Unset = UNSET
    author_timestamp: int | Unset = UNSET
    committer: ExampleJsonLastModifiedCallbackReadmeMdCommitter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: ExampleJsonLastModifiedCallbackReadmeMdAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = ExampleJsonLastModifiedCallbackReadmeMdAuthor.from_dict(_author)

        author_timestamp = d.pop("authorTimestamp", UNSET)

        _committer = d.pop("committer", UNSET)
        committer: ExampleJsonLastModifiedCallbackReadmeMdCommitter | Unset
        if isinstance(_committer, Unset):
            committer = UNSET
        else:
            committer = ExampleJsonLastModifiedCallbackReadmeMdCommitter.from_dict(_committer)
        ...
        example_json_last_modified_callback_readme_md = cls(
            author=author,
        ...
        example_json_last_modified_callback_readme_md.additional_properties = d
        return example_json_last_modified_callback_readme_md
