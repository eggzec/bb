...
if TYPE_CHECKING:
    from ..models.rest_comment_anchor import RestCommentAnchor
    from ..models.rest_comment_author import RestCommentAuthor
    from ..models.rest_comment_parent import RestCommentParent
    from ..models.rest_comment_properties import RestCommentProperties
    from ..models.rest_comment_resolver import RestCommentResolver
    from ..models.rest_comment_thread_resolver import RestCommentThreadResolver


T = TypeVar("T", bound="RestComment")


@_attrs_define
class RestComment:
    anchor: RestCommentAnchor | Unset = UNSET
    anchored: bool | Unset = UNSET
    author: RestCommentAuthor | Unset = UNSET
    comments: list[RestComment] | Unset = UNSET
    created_date: int | Unset = UNSET
    html: str | Unset = UNSET
    id: int | Unset = UNSET
    parent: RestCommentParent | Unset = UNSET
    pending: bool | Unset = UNSET
    properties: RestCommentProperties | Unset = UNSET
    reply: bool | Unset = UNSET
    resolved_date: int | Unset = UNSET
    resolver: RestCommentResolver | Unset = UNSET
    ...
    thread_resolver: RestCommentThreadResolver | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        anchor: RestCommentAnchor | Unset
        if isinstance(_anchor, Unset):
            anchor = UNSET
        else:
            anchor = RestCommentAnchor.from_dict(_anchor)

        anchored = d.pop("anchored", UNSET)

        _author = d.pop("author", UNSET)
        author: RestCommentAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestCommentAuthor.from_dict(_author)
        ...
        parent: RestCommentParent | Unset
        if isinstance(_parent, Unset):
            parent = UNSET
        else:
            parent = RestCommentParent.from_dict(_parent)

        pending = d.pop("pending", UNSET)

        _properties = d.pop("properties", UNSET)
        properties: RestCommentProperties | Unset
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = RestCommentProperties.from_dict(_properties)
        ...
        resolver: RestCommentResolver | Unset
        if isinstance(_resolver, Unset):
            resolver = UNSET
        else:
            resolver = RestCommentResolver.from_dict(_resolver)
        ...
        thread_resolver: RestCommentThreadResolver | Unset
        if isinstance(_thread_resolver, Unset):
            thread_resolver = UNSET
        else:
            thread_resolver = RestCommentThreadResolver.from_dict(_thread_resolver)
        ...
        rest_comment.additional_properties = d
        return rest_comment
