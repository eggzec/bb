...
from ..models.rest_pull_request_mergeability_outcome import RestPullRequestMergeabilityOutcome
...
T = TypeVar("T", bound="RestPullRequestMergeability")


@_attrs_define
class RestPullRequestMergeability:
    conflicted: bool | Unset = UNSET
    outcome: RestPullRequestMergeabilityOutcome | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if conflicted is not UNSET:
            field_dict["conflicted"] = conflicted
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        conflicted = d.pop("conflicted", UNSET)

        _outcome = d.pop("outcome", UNSET)
        outcome: RestPullRequestMergeabilityOutcome | Unset
        if isinstance(_outcome, Unset):
            outcome = UNSET
        else:
            outcome = RestPullRequestMergeabilityOutcome(_outcome)
        ...
        rest_pull_request_mergeability = cls(
            conflicted=conflicted,
            outcome=outcome,
            vetoes=vetoes,
        )

        rest_pull_request_mergeability.additional_properties = d
        return rest_pull_request_mergeability
