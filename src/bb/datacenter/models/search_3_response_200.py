...
T = TypeVar("T", bound="Search3Response200")


@_attrs_define
class Search3Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_3_response_200.additional_properties = d
        return search_3_response_200
