...
T = TypeVar("T", bound="TotpRecoveryCodeDTO")


@_attrs_define
class TotpRecoveryCodeDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        totp_recovery_code_dto = cls(
            recovery_code=recovery_code,
        )

        totp_recovery_code_dto.additional_properties = d
        return totp_recovery_code_dto
