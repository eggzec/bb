...
T = TypeVar("T", bound="RestExportRequestRepositoriesRequest")


@_attrs_define
class RestExportRequestRepositoriesRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_export_request_repositories_request = cls(
            includes=includes,
        )

        rest_export_request_repositories_request.additional_properties = d
        return rest_export_request_repositories_request
