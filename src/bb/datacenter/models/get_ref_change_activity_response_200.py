...
if TYPE_CHECKING:
    from ..models.rest_repository_ref_change_activity import RestRepositoryRefChangeActivity


T = TypeVar("T", bound="GetRefChangeActivityResponse200")


@_attrs_define
class GetRefChangeActivityResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestRepositoryRefChangeActivity] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestRepositoryRefChangeActivity.from_dict(values_item_data)

                values.append(values_item)

        get_ref_change_activity_response_200 = cls(
        ...
        get_ref_change_activity_response_200.additional_properties = d
        return get_ref_change_activity_response_200
