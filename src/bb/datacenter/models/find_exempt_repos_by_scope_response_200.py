...
T = TypeVar("T", bound="FindExemptReposByScopeResponse200")


@_attrs_define
class FindExemptReposByScopeResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_exempt_repos_by_scope_response_200 = cls(
        ...
        find_exempt_repos_by_scope_response_200.additional_properties = d
        return find_exempt_repos_by_scope_response_200
