...
T = TypeVar("T", bound="GetRestrictionsResponse200")


@_attrs_define
class GetRestrictionsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_restrictions_response_200 = cls(
        ...
        get_restrictions_response_200.additional_properties = d
        return get_restrictions_response_200
