...
T = TypeVar("T", bound="GetExportJobMessagesResponse200")


@_attrs_define
class GetExportJobMessagesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_export_job_messages_response_200 = cls(
        ...
        get_export_job_messages_response_200.additional_properties = d
        return get_export_job_messages_response_200
