...
T = TypeVar("T", bound="RestCommentParentAnchorMultilineSpan")


@_attrs_define
class RestCommentParentAnchorMultilineSpan:
    dst_span_end: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_comment_parent_anchor_multiline_span = cls(
        ...
        rest_comment_parent_anchor_multiline_span.additional_properties = d
        return rest_comment_parent_anchor_multiline_span
