...
T = TypeVar("T", bound="RestUserReactionCommentAnchorMultilineSpan")


@_attrs_define
class RestUserReactionCommentAnchorMultilineSpan:
    dst_span_end: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_user_reaction_comment_anchor_multiline_span = cls(
        ...
        rest_user_reaction_comment_anchor_multiline_span.additional_properties = d
        return rest_user_reaction_comment_anchor_multiline_span
