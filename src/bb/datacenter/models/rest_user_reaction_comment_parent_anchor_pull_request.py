...
from ..models.rest_user_reaction_comment_parent_anchor_pull_request_state import (
...
if TYPE_CHECKING:
    ...
    from ..models.rest_user_reaction_comment_parent_anchor_pull_request_author import (
        RestUserReactionCommentParentAnchorPullRequestAuthor,
    )
    from ..models.rest_user_reaction_comment_parent_anchor_pull_request_from_ref import (
        RestUserReactionCommentParentAnchorPullRequestFromRef,
    )
    from ..models.rest_user_reaction_comment_parent_anchor_pull_request_links import (
        RestUserReactionCommentParentAnchorPullRequestLinks,
    )
    from ..models.rest_user_reaction_comment_parent_anchor_pull_request_to_ref import (
        RestUserReactionCommentParentAnchorPullRequestToRef,
    )


T = TypeVar("T", bound="RestUserReactionCommentParentAnchorPullRequest")


@_attrs_define
class RestUserReactionCommentParentAnchorPullRequest:
    author: RestUserReactionCommentParentAnchorPullRequestAuthor | Unset = UNSET
    ...
    from_ref: RestUserReactionCommentParentAnchorPullRequestFromRef | Unset = UNSET
    html_description: str | Unset = UNSET
    id: int | Unset = UNSET
    links: RestUserReactionCommentParentAnchorPullRequestLinks | Unset = UNSET
    ...
    state: RestUserReactionCommentParentAnchorPullRequestState | Unset = UNSET
    title: str | Unset = UNSET
    to_ref: RestUserReactionCommentParentAnchorPullRequestToRef | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestUserReactionCommentParentAnchorPullRequestAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestUserReactionCommentParentAnchorPullRequestAuthor.from_dict(_author)
        ...
        from_ref: RestUserReactionCommentParentAnchorPullRequestFromRef | Unset
        if isinstance(_from_ref, Unset):
            from_ref = UNSET
        else:
            from_ref = RestUserReactionCommentParentAnchorPullRequestFromRef.from_dict(_from_ref)
        ...
        links: RestUserReactionCommentParentAnchorPullRequestLinks | Unset
        if isinstance(_links, Unset):
            links = UNSET
        else:
            links = RestUserReactionCommentParentAnchorPullRequestLinks.from_dict(_links)
        ...
        state: RestUserReactionCommentParentAnchorPullRequestState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = RestUserReactionCommentParentAnchorPullRequestState(_state)

        title = d.pop("title", UNSET)

        _to_ref = d.pop("toRef", UNSET)
        to_ref: RestUserReactionCommentParentAnchorPullRequestToRef | Unset
        if isinstance(_to_ref, Unset):
            to_ref = UNSET
        else:
            to_ref = RestUserReactionCommentParentAnchorPullRequestToRef.from_dict(_to_ref)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_user_reaction_comment_parent_anchor_pull_request = cls(
            author=author,
            closed=closed,
        ...
        rest_user_reaction_comment_parent_anchor_pull_request.additional_properties = d
        return rest_user_reaction_comment_parent_anchor_pull_request
