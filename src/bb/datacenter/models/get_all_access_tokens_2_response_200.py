...
T = TypeVar("T", bound="GetAllAccessTokens2Response200")


@_attrs_define
class GetAllAccessTokens2Response200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestAccessToken] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestAccessToken.from_dict(values_item_data)

                values.append(values_item)

        get_all_access_tokens_2_response_200 = cls(
        ...
        get_all_access_tokens_2_response_200.additional_properties = d
        return get_all_access_tokens_2_response_200
