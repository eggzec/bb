...
T = TypeVar("T", bound="GetComments2Response200")


@_attrs_define
class GetComments2Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_comments_2_response_200 = cls(
        ...
        get_comments_2_response_200.additional_properties = d
        return get_comments_2_response_200
