...
if TYPE_CHECKING:
    from ..models.rest_changeset import RestChangeset


T = TypeVar("T", bound="GetCommitsByIssueKeyResponse200")


@_attrs_define
class GetCommitsByIssueKeyResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestChangeset] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestChangeset.from_dict(values_item_data)

                values.append(values_item)

        get_commits_by_issue_key_response_200 = cls(
        ...
        get_commits_by_issue_key_response_200.additional_properties = d
        return get_commits_by_issue_key_response_200
