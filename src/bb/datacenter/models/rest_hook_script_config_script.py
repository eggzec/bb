...
from ..models.rest_hook_script_config_script_type import RestHookScriptConfigScriptType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RestHookScriptConfigScript")


@_attrs_define
class RestHookScriptConfigScript:
    created_date: datetime.datetime | Unset = UNSET
    description: str | Unset = UNSET
    id: int | Unset = UNSET
    name: str | Unset = UNSET
    plugin_key: str | Unset = UNSET
    type_: RestHookScriptConfigScriptType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: RestHookScriptConfigScriptType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = RestHookScriptConfigScriptType(_type_)
        ...
        rest_hook_script_config_script = cls(
        ...
        rest_hook_script_config_script.additional_properties = d
        return rest_hook_script_config_script
