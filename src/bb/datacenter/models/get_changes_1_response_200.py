...
T = TypeVar("T", bound="GetChanges1Response200")


@_attrs_define
class GetChanges1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_changes_1_response_200 = cls(
        ...
        get_changes_1_response_200.additional_properties = d
        return get_changes_1_response_200
