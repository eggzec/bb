...
T = TypeVar("T", bound="Search4Response200")


@_attrs_define
class Search4Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_4_response_200.additional_properties = d
        return search_4_response_200
