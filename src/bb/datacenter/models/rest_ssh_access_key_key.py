...
T = TypeVar("T", bound="RestSshAccessKeyKey")


@_attrs_define
class RestSshAccessKeyKey:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_ssh_access_key_key.additional_properties = d
        return rest_ssh_access_key_key
