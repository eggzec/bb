...
T = TypeVar("T", bound="RestCommentParentAnchorPath")


@_attrs_define
class RestCommentParentAnchorPath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_comment_parent_anchor_path = cls(
        ...
        rest_comment_parent_anchor_path.additional_properties = d
        return rest_comment_parent_anchor_path
