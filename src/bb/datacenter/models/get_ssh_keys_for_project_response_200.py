...
T = TypeVar("T", bound="GetSshKeysForProjectResponse200")


@_attrs_define
class GetSshKeysForProjectResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestSshAccessKey] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestSshAccessKey.from_dict(values_item_data)

                values.append(values_item)

        get_ssh_keys_for_project_response_200 = cls(
        ...
        get_ssh_keys_for_project_response_200.additional_properties = d
        return get_ssh_keys_for_project_response_200
