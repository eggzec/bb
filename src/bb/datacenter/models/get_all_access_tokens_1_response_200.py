...
T = TypeVar("T", bound="GetAllAccessTokens1Response200")


@_attrs_define
class GetAllAccessTokens1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_access_tokens_1_response_200 = cls(
        ...
        get_all_access_tokens_1_response_200.additional_properties = d
        return get_all_access_tokens_1_response_200
