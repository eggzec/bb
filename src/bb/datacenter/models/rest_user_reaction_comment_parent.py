...
if TYPE_CHECKING:
    ...
    from ..models.rest_user_reaction_comment_parent_anchor import RestUserReactionCommentParentAnchor
    from ..models.rest_user_reaction_comment_parent_author import RestUserReactionCommentParentAuthor
    from ..models.rest_user_reaction_comment_parent_properties import RestUserReactionCommentParentProperties
    from ..models.rest_user_reaction_comment_parent_resolver import RestUserReactionCommentParentResolver
    from ..models.rest_user_reaction_comment_parent_thread_resolver import RestUserReactionCommentParentThreadResolver


T = TypeVar("T", bound="RestUserReactionCommentParent")


@_attrs_define
class RestUserReactionCommentParent:
    anchor: RestUserReactionCommentParentAnchor | Unset = UNSET
    anchored: bool | Unset = UNSET
    author: RestUserReactionCommentParentAuthor | Unset = UNSET
    comments: list[RestComment] | Unset = UNSET
    created_date: int | Unset = UNSET
    html: str | Unset = UNSET
    id: int | Unset = UNSET
    pending: bool | Unset = UNSET
    properties: RestUserReactionCommentParentProperties | Unset = UNSET
    reply: bool | Unset = UNSET
    resolved_date: int | Unset = UNSET
    resolver: RestUserReactionCommentParentResolver | Unset = UNSET
    ...
    thread_resolver: RestUserReactionCommentParentThreadResolver | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.rest_user_reaction_comment_parent_properties import RestUserReactionCommentParentProperties
        from ..models.rest_user_reaction_comment_parent_resolver import RestUserReactionCommentParentResolver
        from ..models.rest_user_reaction_comment_parent_thread_resolver import (
            RestUserReactionCommentParentThreadResolver,
        )

        d = dict(src_dict)
        _anchor = d.pop("anchor", UNSET)
        anchor: RestUserReactionCommentParentAnchor | Unset
        if isinstance(_anchor, Unset):
            anchor = UNSET
        else:
            anchor = RestUserReactionCommentParentAnchor.from_dict(_anchor)

        anchored = d.pop("anchored", UNSET)

        _author = d.pop("author", UNSET)
        author: RestUserReactionCommentParentAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestUserReactionCommentParentAuthor.from_dict(_author)
        ...
        properties: RestUserReactionCommentParentProperties | Unset
        if isinstance(_properties, Unset):
            properties = UNSET
        else:
            properties = RestUserReactionCommentParentProperties.from_dict(_properties)
        ...
        resolver: RestUserReactionCommentParentResolver | Unset
        if isinstance(_resolver, Unset):
            resolver = UNSET
        else:
            resolver = RestUserReactionCommentParentResolver.from_dict(_resolver)
        ...
        thread_resolver: RestUserReactionCommentParentThreadResolver | Unset
        if isinstance(_thread_resolver, Unset):
            thread_resolver = UNSET
        else:
            thread_resolver = RestUserReactionCommentParentThreadResolver.from_dict(_thread_resolver)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_user_reaction_comment_parent = cls(
            anchor=anchor,
            anchored=anchored,
            author=author,
            comments=comments,
        ...
        rest_user_reaction_comment_parent.additional_properties = d
        return rest_user_reaction_comment_parent
