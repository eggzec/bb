...
class StreamFiles1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stream_files_1_response_200 = cls(
        ...
        stream_files_1_response_200.additional_properties = d
        return stream_files_1_response_200
