...
T = TypeVar("T", bound="StreamFilesResponse200")


@_attrs_define
class StreamFilesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stream_files_response_200.additional_properties = d
        return stream_files_response_200
