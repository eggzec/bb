...
T = TypeVar("T", bound="RestConflictOurChangePath")


@_attrs_define
class RestConflictOurChangePath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_conflict_our_change_path = cls(
        ...
        rest_conflict_our_change_path.additional_properties = d
        return rest_conflict_our_change_path
