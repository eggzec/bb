...
if TYPE_CHECKING:
    from ..models.rest_conflict_our_change import RestConflictOurChange
    from ..models.rest_conflict_their_change import RestConflictTheirChange


T = TypeVar("T", bound="RestConflict")


@_attrs_define
class RestConflict:
    our_change: RestConflictOurChange | Unset = UNSET
    their_change: RestConflictTheirChange | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        our_change: RestConflictOurChange | Unset
        if isinstance(_our_change, Unset):
            our_change = UNSET
        else:
            our_change = RestConflictOurChange.from_dict(_our_change)

        _their_change = d.pop("theirChange", UNSET)
        their_change: RestConflictTheirChange | Unset
        if isinstance(_their_change, Unset):
            their_change = UNSET
        else:
            their_change = RestConflictTheirChange.from_dict(_their_change)
        ...
        rest_conflict.additional_properties = d
