...
if TYPE_CHECKING:
    from ..models.rest_pull_request_activity import RestPullRequestActivity


T = TypeVar("T", bound="GetActivitiesResponse200")


@_attrs_define
class GetActivitiesResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestPullRequestActivity] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestPullRequestActivity.from_dict(values_item_data)

                values.append(values_item)

        get_activities_response_200 = cls(
        ...
        get_activities_response_200.additional_properties = d
        return get_activities_response_200
