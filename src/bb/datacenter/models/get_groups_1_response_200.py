...
T = TypeVar("T", bound="GetGroups1Response200")


@_attrs_define
class GetGroups1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_1_response_200.additional_properties = d
        return get_groups_1_response_200
