...
from ..models.rest_index_event_event_type import RestIndexEventEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rest_index_event_event_metadata import RestIndexEventEventMetadata


T = TypeVar("T", bound="RestIndexEvent")


@_attrs_define
class RestIndexEvent:
    """The event that is currently being processed by the indexing worker."""

    event_type: RestIndexEventEventType
    ...
    """
    event_metadata: RestIndexEventEventMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        event_type = RestIndexEventEventType(d.pop("eventType"))

        retries = d.pop("retries")

        _event_metadata = d.pop("eventMetadata", UNSET)
        event_metadata: RestIndexEventEventMetadata | Unset
        if isinstance(_event_metadata, Unset):
            event_metadata = UNSET
        else:
            event_metadata = RestIndexEventEventMetadata.from_dict(_event_metadata)

        rest_index_event = cls(
            event_type=event_type,
            retries=retries,
            event_metadata=event_metadata,
        )

        rest_index_event.additional_properties = d
        return rest_index_event
