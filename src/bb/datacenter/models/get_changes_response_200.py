...
T = TypeVar("T", bound="GetChangesResponse200")


@_attrs_define
class GetChangesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_changes_response_200.additional_properties = d
        return get_changes_response_200
