...
T = TypeVar("T", bound="GetConfigurationsResponse200")


@_attrs_define
class GetConfigurationsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_configurations_response_200 = cls(
        ...
        get_configurations_response_200.additional_properties = d
        return get_configurations_response_200
