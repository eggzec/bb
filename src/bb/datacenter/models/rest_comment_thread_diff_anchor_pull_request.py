...
from ..models.rest_comment_thread_diff_anchor_pull_request_state import RestCommentThreadDiffAnchorPullRequestState
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rest_comment_thread_diff_anchor_pull_request_author import (
        RestCommentThreadDiffAnchorPullRequestAuthor,
    )
    from ..models.rest_comment_thread_diff_anchor_pull_request_from_ref import (
        RestCommentThreadDiffAnchorPullRequestFromRef,
    )
    from ..models.rest_comment_thread_diff_anchor_pull_request_links import RestCommentThreadDiffAnchorPullRequestLinks
    from ..models.rest_comment_thread_diff_anchor_pull_request_to_ref import RestCommentThreadDiffAnchorPullRequestToRef
    from ..models.rest_pull_request_participant import RestPullRequestParticipant


T = TypeVar("T", bound="RestCommentThreadDiffAnchorPullRequest")


@_attrs_define
class RestCommentThreadDiffAnchorPullRequest:
    author: RestCommentThreadDiffAnchorPullRequestAuthor | Unset = UNSET
    ...
    from_ref: RestCommentThreadDiffAnchorPullRequestFromRef | Unset = UNSET
    html_description: str | Unset = UNSET
    id: int | Unset = UNSET
    links: RestCommentThreadDiffAnchorPullRequestLinks | Unset = UNSET
    ...
    state: RestCommentThreadDiffAnchorPullRequestState | Unset = UNSET
    title: str | Unset = UNSET
    to_ref: RestCommentThreadDiffAnchorPullRequestToRef | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.rest_comment_thread_diff_anchor_pull_request_links import (
            RestCommentThreadDiffAnchorPullRequestLinks,
        )
        from ..models.rest_comment_thread_diff_anchor_pull_request_to_ref import (
        ...
        author: RestCommentThreadDiffAnchorPullRequestAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestCommentThreadDiffAnchorPullRequestAuthor.from_dict(_author)
        ...
        from_ref: RestCommentThreadDiffAnchorPullRequestFromRef | Unset
        if isinstance(_from_ref, Unset):
            from_ref = UNSET
        else:
            from_ref = RestCommentThreadDiffAnchorPullRequestFromRef.from_dict(_from_ref)
        ...
        links: RestCommentThreadDiffAnchorPullRequestLinks | Unset
        if isinstance(_links, Unset):
            links = UNSET
        else:
            links = RestCommentThreadDiffAnchorPullRequestLinks.from_dict(_links)
        ...
        state: RestCommentThreadDiffAnchorPullRequestState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = RestCommentThreadDiffAnchorPullRequestState(_state)

        title = d.pop("title", UNSET)

        _to_ref = d.pop("toRef", UNSET)
        to_ref: RestCommentThreadDiffAnchorPullRequestToRef | Unset
        if isinstance(_to_ref, Unset):
            to_ref = UNSET
        else:
            to_ref = RestCommentThreadDiffAnchorPullRequestToRef.from_dict(_to_ref)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_comment_thread_diff_anchor_pull_request = cls(
            author=author,
            closed=closed,
        ...
        rest_comment_thread_diff_anchor_pull_request.additional_properties = d
        return rest_comment_thread_diff_anchor_pull_request
