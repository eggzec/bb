...
if TYPE_CHECKING:
    from ..models.example_json_last_modified_callback_latest_commit_author import (
        ExampleJsonLastModifiedCallbackLatestCommitAuthor,
    )
    from ..models.example_json_last_modified_callback_latest_commit_committer import (
        ExampleJsonLastModifiedCallbackLatestCommitCommitter,
    )
    from ..models.rest_minimal_commit import RestMinimalCommit


T = TypeVar("T", bound="ExampleJsonLastModifiedCallbackLatestCommit")


@_attrs_define
class ExampleJsonLastModifiedCallbackLatestCommit:
    author: ExampleJsonLastModifiedCallbackLatestCommitAuthor | Unset = UNSET
    author_timestamp: int | Unset = UNSET
    committer: ExampleJsonLastModifiedCallbackLatestCommitCommitter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: ExampleJsonLastModifiedCallbackLatestCommitAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = ExampleJsonLastModifiedCallbackLatestCommitAuthor.from_dict(_author)

        author_timestamp = d.pop("authorTimestamp", UNSET)

        _committer = d.pop("committer", UNSET)
        committer: ExampleJsonLastModifiedCallbackLatestCommitCommitter | Unset
        if isinstance(_committer, Unset):
            committer = UNSET
        else:
            committer = ExampleJsonLastModifiedCallbackLatestCommitCommitter.from_dict(_committer)
        ...
        example_json_last_modified_callback_latest_commit = cls(
            author=author,
        ...
        example_json_last_modified_callback_latest_commit.additional_properties = d
        return example_json_last_modified_callback_latest_commit
