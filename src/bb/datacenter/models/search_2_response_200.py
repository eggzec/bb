...
T = TypeVar("T", bound="Search2Response200")


@_attrs_define
class Search2Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_2_response_200.additional_properties = d
        return search_2_response_200
