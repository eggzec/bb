...
T = TypeVar("T", bound="RestCommentAnchorSrcPath")


@_attrs_define
class RestCommentAnchorSrcPath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_comment_anchor_src_path = cls(
        ...
        rest_comment_anchor_src_path.additional_properties = d
        return rest_comment_anchor_src_path
