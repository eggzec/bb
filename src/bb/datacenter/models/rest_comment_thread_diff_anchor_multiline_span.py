...
T = TypeVar("T", bound="RestCommentThreadDiffAnchorMultilineSpan")


@_attrs_define
class RestCommentThreadDiffAnchorMultilineSpan:
    dst_span_end: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_comment_thread_diff_anchor_multiline_span = cls(
        ...
        rest_comment_thread_diff_anchor_multiline_span.additional_properties = d
        return rest_comment_thread_diff_anchor_multiline_span
