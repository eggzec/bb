...
T = TypeVar("T", bound="GetReviewerGroupsResponse200")


@_attrs_define
class GetReviewerGroupsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_reviewer_groups_response_200 = cls(
        ...
        get_reviewer_groups_response_200.additional_properties = d
        return get_reviewer_groups_response_200
