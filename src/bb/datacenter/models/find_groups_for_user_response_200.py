...
T = TypeVar("T", bound="FindGroupsForUserResponse200")


@_attrs_define
class FindGroupsForUserResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_groups_for_user_response_200 = cls(
        ...
        find_groups_for_user_response_200.additional_properties = d
        return find_groups_for_user_response_200
