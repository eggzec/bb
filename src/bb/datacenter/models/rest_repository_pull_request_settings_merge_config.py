...
if TYPE_CHECKING:
    ...
    from ..models.rest_repository_pull_request_settings_merge_config_commit_message_template import (
        RestRepositoryPullRequestSettingsMergeConfigCommitMessageTemplate,
    )
    from ..models.rest_repository_pull_request_settings_merge_config_default_strategy import (
        RestRepositoryPullRequestSettingsMergeConfigDefaultStrategy,
    )


T = TypeVar("T", bound="RestRepositoryPullRequestSettingsMergeConfig")


@_attrs_define
class RestRepositoryPullRequestSettingsMergeConfig:
    strategies: list[RestPullRequestMergeStrategy]
    commit_message_template: RestRepositoryPullRequestSettingsMergeConfigCommitMessageTemplate | Unset = UNSET
    commit_summaries: int | Unset = UNSET
    default_strategy: RestRepositoryPullRequestSettingsMergeConfigDefaultStrategy | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        commit_message_template: RestRepositoryPullRequestSettingsMergeConfigCommitMessageTemplate | Unset
        if isinstance(_commit_message_template, Unset):
            commit_message_template = UNSET
        else:
            commit_message_template = RestRepositoryPullRequestSettingsMergeConfigCommitMessageTemplate.from_dict(
        ...
        default_strategy: RestRepositoryPullRequestSettingsMergeConfigDefaultStrategy | Unset
        if isinstance(_default_strategy, Unset):
            default_strategy = UNSET
        else:
            default_strategy = RestRepositoryPullRequestSettingsMergeConfigDefaultStrategy.from_dict(_default_strategy)

        type_ = d.pop("type", UNSET)

        rest_repository_pull_request_settings_merge_config = cls(
            strategies=strategies,
        ...
        rest_repository_pull_request_settings_merge_config.additional_properties = d
        return rest_repository_pull_request_settings_merge_config
