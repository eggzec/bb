...
T = TypeVar("T", bound="GetGroupsWithoutAnyPermission2Response200")


@_attrs_define
class GetGroupsWithoutAnyPermission2Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_without_any_permission_2_response_200 = cls(
        ...
        get_groups_without_any_permission_2_response_200.additional_properties = d
        return get_groups_without_any_permission_2_response_200
