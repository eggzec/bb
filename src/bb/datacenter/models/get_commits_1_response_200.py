...
T = TypeVar("T", bound="GetCommits1Response200")


@_attrs_define
class GetCommits1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_commits_1_response_200 = cls(
        ...
        get_commits_1_response_200.additional_properties = d
        return get_commits_1_response_200
