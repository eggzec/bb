...
T = TypeVar("T", bound="RestConflictChangePath")


@_attrs_define
class RestConflictChangePath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_conflict_change_path.additional_properties = d
        return rest_conflict_change_path
