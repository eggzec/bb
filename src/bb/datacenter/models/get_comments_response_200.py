...
T = TypeVar("T", bound="GetCommentsResponse200")


@_attrs_define
class GetCommentsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_comments_response_200.additional_properties = d
        return get_comments_response_200
