...
T = TypeVar("T", bound="GetRepositoryHooksResponse200")


@_attrs_define
class GetRepositoryHooksResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_repository_hooks_response_200 = cls(
        ...
        get_repository_hooks_response_200.additional_properties = d
        return get_repository_hooks_response_200
