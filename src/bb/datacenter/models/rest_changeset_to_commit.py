...
if TYPE_CHECKING:
    ...
    from ..models.rest_changeset_to_commit_committer import RestChangesetToCommitCommitter
    from ..models.rest_minimal_commit import RestMinimalCommit


T = TypeVar("T", bound="RestChangesetToCommit")


@_attrs_define
class RestChangesetToCommit:
    author: RestChangesetToCommitAuthor | Unset = UNSET
    author_timestamp: int | Unset = UNSET
    committer: RestChangesetToCommitCommitter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestChangesetToCommitAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestChangesetToCommitAuthor.from_dict(_author)

        author_timestamp = d.pop("authorTimestamp", UNSET)

        _committer = d.pop("committer", UNSET)
        committer: RestChangesetToCommitCommitter | Unset
        if isinstance(_committer, Unset):
            committer = UNSET
        else:
            committer = RestChangesetToCommitCommitter.from_dict(_committer)
        ...
        rest_changeset_to_commit.additional_properties = d
        return rest_changeset_to_commit
