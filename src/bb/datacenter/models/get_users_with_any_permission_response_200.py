...
T = TypeVar("T", bound="GetUsersWithAnyPermissionResponse200")


@_attrs_define
class GetUsersWithAnyPermissionResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_with_any_permission_response_200 = cls(
        ...
        get_users_with_any_permission_response_200.additional_properties = d
        return get_users_with_any_permission_response_200
