...
if TYPE_CHECKING:
    from ..models.rest_pull_request_suggestion import RestPullRequestSuggestion


T = TypeVar("T", bound="GetPullRequestSuggestionsResponse200")


@_attrs_define
class GetPullRequestSuggestionsResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestPullRequestSuggestion] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestPullRequestSuggestion.from_dict(values_item_data)

                values.append(values_item)

        get_pull_request_suggestions_response_200 = cls(
        ...
        get_pull_request_suggestions_response_200.additional_properties = d
        return get_pull_request_suggestions_response_200
