...
T = TypeVar("T", bound="RestCommentAnchorPath")


@_attrs_define
class RestCommentAnchorPath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_comment_anchor_path.additional_properties = d
        return rest_comment_anchor_path
