...
if TYPE_CHECKING:
    ...
    from ..models.rest_default_reviewers_request_source_matcher import RestDefaultReviewersRequestSourceMatcher
    from ..models.rest_default_reviewers_request_target_matcher import RestDefaultReviewersRequestTargetMatcher
    from ..models.rest_reviewer_group import RestReviewerGroup


T = TypeVar("T", bound="RestDefaultReviewersRequest")


@_attrs_define
class RestDefaultReviewersRequest:
    ...
    source_matcher: RestDefaultReviewersRequestSourceMatcher | Unset = UNSET
    target_matcher: RestDefaultReviewersRequestTargetMatcher | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        source_matcher: RestDefaultReviewersRequestSourceMatcher | Unset
        if isinstance(_source_matcher, Unset):
            source_matcher = UNSET
        else:
            source_matcher = RestDefaultReviewersRequestSourceMatcher.from_dict(_source_matcher)

        _target_matcher = d.pop("targetMatcher", UNSET)
        target_matcher: RestDefaultReviewersRequestTargetMatcher | Unset
        if isinstance(_target_matcher, Unset):
            target_matcher = UNSET
        else:
            target_matcher = RestDefaultReviewersRequestTargetMatcher.from_dict(_target_matcher)

        rest_default_reviewers_request = cls(
        ...
        rest_default_reviewers_request.additional_properties = d
        return rest_default_reviewers_request
