...
T = TypeVar("T", bound="RestBitbucketLicenseStatus")


@_attrs_define
class RestBitbucketLicenseStatus:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_bitbucket_license_status = cls(
            current_number_of_users=current_number_of_users,
            server_id=server_id,
        )

        rest_bitbucket_license_status.additional_properties = d
        return rest_bitbucket_license_status
