...
T = TypeVar("T", bound="GetGroupsWithAnyPermission1Response200")


@_attrs_define
class GetGroupsWithAnyPermission1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_with_any_permission_1_response_200 = cls(
        ...
        get_groups_with_any_permission_1_response_200.additional_properties = d
        return get_groups_with_any_permission_1_response_200
