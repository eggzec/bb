...
from ..models.rest_auto_merge_processing_result_pull_request_state import RestAutoMergeProcessingResultPullRequestState
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rest_auto_merge_processing_result_pull_request_author import (
        RestAutoMergeProcessingResultPullRequestAuthor,
    )
    from ..models.rest_auto_merge_processing_result_pull_request_from_ref import (
        RestAutoMergeProcessingResultPullRequestFromRef,
    )
    from ..models.rest_auto_merge_processing_result_pull_request_links import (
        RestAutoMergeProcessingResultPullRequestLinks,
    )
    from ..models.rest_auto_merge_processing_result_pull_request_to_ref import (
        RestAutoMergeProcessingResultPullRequestToRef,
    )
    from ..models.rest_pull_request_participant import RestPullRequestParticipant


T = TypeVar("T", bound="RestAutoMergeProcessingResultPullRequest")


@_attrs_define
class RestAutoMergeProcessingResultPullRequest:
    author: RestAutoMergeProcessingResultPullRequestAuthor | Unset = UNSET
    ...
    from_ref: RestAutoMergeProcessingResultPullRequestFromRef | Unset = UNSET
    html_description: str | Unset = UNSET
    id: int | Unset = UNSET
    links: RestAutoMergeProcessingResultPullRequestLinks | Unset = UNSET
    ...
    state: RestAutoMergeProcessingResultPullRequestState | Unset = UNSET
    title: str | Unset = UNSET
    to_ref: RestAutoMergeProcessingResultPullRequestToRef | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestAutoMergeProcessingResultPullRequestAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestAutoMergeProcessingResultPullRequestAuthor.from_dict(_author)
        ...
        from_ref: RestAutoMergeProcessingResultPullRequestFromRef | Unset
        if isinstance(_from_ref, Unset):
            from_ref = UNSET
        else:
            from_ref = RestAutoMergeProcessingResultPullRequestFromRef.from_dict(_from_ref)
        ...
        links: RestAutoMergeProcessingResultPullRequestLinks | Unset
        if isinstance(_links, Unset):
            links = UNSET
        else:
            links = RestAutoMergeProcessingResultPullRequestLinks.from_dict(_links)
        ...
        state: RestAutoMergeProcessingResultPullRequestState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = RestAutoMergeProcessingResultPullRequestState(_state)

        title = d.pop("title", UNSET)

        _to_ref = d.pop("toRef", UNSET)
        to_ref: RestAutoMergeProcessingResultPullRequestToRef | Unset
        if isinstance(_to_ref, Unset):
            to_ref = UNSET
        else:
            to_ref = RestAutoMergeProcessingResultPullRequestToRef.from_dict(_to_ref)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_auto_merge_processing_result_pull_request = cls(
            author=author,
            closed=closed,
        ...
        rest_auto_merge_processing_result_pull_request.additional_properties = d
        return rest_auto_merge_processing_result_pull_request
