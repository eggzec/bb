...
T = TypeVar("T", bound="EnrichedRepositoryProperties")


@_attrs_define
class EnrichedRepositoryProperties:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enriched_repository_properties = cls(
            content_hash=content_hash,
            default_branch_id=default_branch_id,
            metadata_hash=metadata_hash,
        )

        enriched_repository_properties.additional_properties = d
        return enriched_repository_properties
