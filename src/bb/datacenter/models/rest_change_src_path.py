...
T = TypeVar("T", bound="RestChangeSrcPath")


@_attrs_define
class RestChangeSrcPath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_change_src_path.additional_properties = d
        return rest_change_src_path
