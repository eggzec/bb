    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestSecretScanningRule.from_dict(values_item_data)

                values.append(values_item)

        search_1_response_200 = cls(
        ...
        search_1_response_200.additional_properties = d
        return search_1_response_200
