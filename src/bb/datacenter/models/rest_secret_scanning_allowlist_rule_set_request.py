...
T = TypeVar("T", bound="RestSecretScanningAllowlistRuleSetRequest")


@_attrs_define
class RestSecretScanningAllowlistRuleSetRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_secret_scanning_allowlist_rule_set_request = cls(
            line_regex=line_regex,
            name=name,
            path_regex=path_regex,
        )

        rest_secret_scanning_allowlist_rule_set_request.additional_properties = d
        return rest_secret_scanning_allowlist_rule_set_request
