...
if TYPE_CHECKING:
    from ..models.rest_commit_author import RestCommitAuthor
    from ..models.rest_commit_committer import RestCommitCommitter
    from ..models.rest_minimal_commit import RestMinimalCommit


T = TypeVar("T", bound="RestCommit")


@_attrs_define
class RestCommit:
    author: RestCommitAuthor | Unset = UNSET
    author_timestamp: int | Unset = UNSET
    committer: RestCommitCommitter | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestCommitAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestCommitAuthor.from_dict(_author)

        author_timestamp = d.pop("authorTimestamp", UNSET)

        _committer = d.pop("committer", UNSET)
        committer: RestCommitCommitter | Unset
        if isinstance(_committer, Unset):
            committer = UNSET
        else:
            committer = RestCommitCommitter.from_dict(_committer)
        ...
        rest_commit.additional_properties = d
        return rest_commit
