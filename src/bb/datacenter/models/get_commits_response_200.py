...
T = TypeVar("T", bound="GetCommitsResponse200")


@_attrs_define
class GetCommitsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_commits_response_200.additional_properties = d
        return get_commits_response_200
