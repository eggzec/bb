    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestComment.from_dict(values_item_data)

                values.append(values_item)

        get_comments_1_response_200 = cls(
        ...
        get_comments_1_response_200.additional_properties = d
        return get_comments_1_response_200
