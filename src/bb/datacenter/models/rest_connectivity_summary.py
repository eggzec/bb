...
T = TypeVar("T", bound="RestConnectivitySummary")


@_attrs_define
class RestConnectivitySummary:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_connectivity_summary = cls(
            error_message=error_message,
            reachable=reachable,
            round_trip_time=round_trip_time,
        )

        rest_connectivity_summary.additional_properties = d
        return rest_connectivity_summary
