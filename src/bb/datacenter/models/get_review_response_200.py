...
T = TypeVar("T", bound="GetReviewResponse200")


@_attrs_define
class GetReviewResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_review_response_200.additional_properties = d
        return get_review_response_200
