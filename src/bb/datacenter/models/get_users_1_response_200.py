...
T = TypeVar("T", bound="GetUsers1Response200")


@_attrs_define
class GetUsers1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_1_response_200.additional_properties = d
        return get_users_1_response_200
