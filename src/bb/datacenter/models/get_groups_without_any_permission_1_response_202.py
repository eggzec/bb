...
T = TypeVar("T", bound="GetGroupsWithoutAnyPermission1Response202")


@_attrs_define
class GetGroupsWithoutAnyPermission1Response202:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestDetailedGroup] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestDetailedGroup.from_dict(values_item_data)

                values.append(values_item)

        get_groups_without_any_permission_1_response_202 = cls(
        ...
        get_groups_without_any_permission_1_response_202.additional_properties = d
        return get_groups_without_any_permission_1_response_202
