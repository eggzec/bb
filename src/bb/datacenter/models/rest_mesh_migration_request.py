...
T = TypeVar("T", bound="RestMeshMigrationRequest")


@_attrs_define
class RestMeshMigrationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_mesh_migration_request = cls(
            project_ids=project_ids,
            repository_ids=repository_ids,
            all_=all_,
        )

        rest_mesh_migration_request.additional_properties = d
        return rest_mesh_migration_request
