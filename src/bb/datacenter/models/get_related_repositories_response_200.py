...
T = TypeVar("T", bound="GetRelatedRepositoriesResponse200")


@_attrs_define
class GetRelatedRepositoriesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_related_repositories_response_200 = cls(
        ...
        get_related_repositories_response_200.additional_properties = d
        return get_related_repositories_response_200
