...
from ..models.rest_pull_request_state import RestPullRequestState
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rest_pull_request_author import RestPullRequestAuthor
    from ..models.rest_pull_request_from_ref import RestPullRequestFromRef
    from ..models.rest_pull_request_links import RestPullRequestLinks
    from ..models.rest_pull_request_participant import RestPullRequestParticipant
    from ..models.rest_pull_request_to_ref import RestPullRequestToRef


T = TypeVar("T", bound="RestPullRequest")


@_attrs_define
class RestPullRequest:
    author: RestPullRequestAuthor | Unset = UNSET
    ...
    from_ref: RestPullRequestFromRef | Unset = UNSET
    html_description: str | Unset = UNSET
    id: int | Unset = UNSET
    links: RestPullRequestLinks | Unset = UNSET
    ...
    state: RestPullRequestState | Unset = UNSET
    title: str | Unset = UNSET
    to_ref: RestPullRequestToRef | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestPullRequestAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestPullRequestAuthor.from_dict(_author)
        ...
        from_ref: RestPullRequestFromRef | Unset
        if isinstance(_from_ref, Unset):
            from_ref = UNSET
        else:
            from_ref = RestPullRequestFromRef.from_dict(_from_ref)
        ...
        links: RestPullRequestLinks | Unset
        if isinstance(_links, Unset):
            links = UNSET
        else:
            links = RestPullRequestLinks.from_dict(_links)
        ...
        state: RestPullRequestState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = RestPullRequestState(_state)

        title = d.pop("title", UNSET)

        _to_ref = d.pop("toRef", UNSET)
        to_ref: RestPullRequestToRef | Unset
        if isinstance(_to_ref, Unset):
            to_ref = UNSET
        else:
            to_ref = RestPullRequestToRef.from_dict(_to_ref)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_pull_request = cls(
            author=author,
            closed=closed,
        ...
        rest_pull_request.additional_properties = d
        return rest_pull_request
