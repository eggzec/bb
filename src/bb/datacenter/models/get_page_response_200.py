...
T = TypeVar("T", bound="GetPageResponse200")


@_attrs_define
class GetPageResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_page_response_200.additional_properties = d
        return get_page_response_200
