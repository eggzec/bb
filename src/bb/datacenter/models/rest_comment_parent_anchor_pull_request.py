...
from ..models.rest_comment_parent_anchor_pull_request_state import RestCommentParentAnchorPullRequestState
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rest_comment_parent_anchor_pull_request_author import RestCommentParentAnchorPullRequestAuthor
    from ..models.rest_comment_parent_anchor_pull_request_from_ref import RestCommentParentAnchorPullRequestFromRef
    from ..models.rest_comment_parent_anchor_pull_request_links import RestCommentParentAnchorPullRequestLinks
    from ..models.rest_comment_parent_anchor_pull_request_to_ref import RestCommentParentAnchorPullRequestToRef
    from ..models.rest_pull_request_participant import RestPullRequestParticipant


T = TypeVar("T", bound="RestCommentParentAnchorPullRequest")


@_attrs_define
class RestCommentParentAnchorPullRequest:
    author: RestCommentParentAnchorPullRequestAuthor | Unset = UNSET
    ...
    from_ref: RestCommentParentAnchorPullRequestFromRef | Unset = UNSET
    html_description: str | Unset = UNSET
    id: int | Unset = UNSET
    links: RestCommentParentAnchorPullRequestLinks | Unset = UNSET
    ...
    state: RestCommentParentAnchorPullRequestState | Unset = UNSET
    title: str | Unset = UNSET
    to_ref: RestCommentParentAnchorPullRequestToRef | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestCommentParentAnchorPullRequestAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestCommentParentAnchorPullRequestAuthor.from_dict(_author)
        ...
        from_ref: RestCommentParentAnchorPullRequestFromRef | Unset
        if isinstance(_from_ref, Unset):
            from_ref = UNSET
        else:
            from_ref = RestCommentParentAnchorPullRequestFromRef.from_dict(_from_ref)
        ...
        links: RestCommentParentAnchorPullRequestLinks | Unset
        if isinstance(_links, Unset):
            links = UNSET
        else:
            links = RestCommentParentAnchorPullRequestLinks.from_dict(_links)
        ...
        state: RestCommentParentAnchorPullRequestState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = RestCommentParentAnchorPullRequestState(_state)

        title = d.pop("title", UNSET)

        _to_ref = d.pop("toRef", UNSET)
        to_ref: RestCommentParentAnchorPullRequestToRef | Unset
        if isinstance(_to_ref, Unset):
            to_ref = UNSET
        else:
            to_ref = RestCommentParentAnchorPullRequestToRef.from_dict(_to_ref)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_comment_parent_anchor_pull_request = cls(
            author=author,
            closed=closed,
        ...
        rest_comment_parent_anchor_pull_request.additional_properties = d
        return rest_comment_parent_anchor_pull_request
