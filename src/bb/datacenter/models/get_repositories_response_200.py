...
T = TypeVar("T", bound="GetRepositoriesResponse200")


@_attrs_define
class GetRepositoriesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_repositories_response_200 = cls(
        ...
        get_repositories_response_200.additional_properties = d
        return get_repositories_response_200
