...
T = TypeVar("T", bound="GetGroupsWithoutAnyPermissionResponse200")


@_attrs_define
class GetGroupsWithoutAnyPermissionResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_without_any_permission_response_200 = cls(
        ...
        get_groups_without_any_permission_response_200.additional_properties = d
        return get_groups_without_any_permission_response_200
