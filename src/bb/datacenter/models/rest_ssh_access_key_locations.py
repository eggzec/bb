...
T = TypeVar("T", bound="RestSshAccessKeyLocations")


@_attrs_define
class RestSshAccessKeyLocations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_ssh_access_key_locations = cls(
            projects=projects,
            repositories=repositories,
        )

        rest_ssh_access_key_locations.additional_properties = d
        return rest_ssh_access_key_locations
