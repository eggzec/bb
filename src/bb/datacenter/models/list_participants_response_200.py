...
T = TypeVar("T", bound="ListParticipantsResponse200")


@_attrs_define
class ListParticipantsResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestPullRequestParticipant] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestPullRequestParticipant.from_dict(values_item_data)

                values.append(values_item)

        list_participants_response_200 = cls(
        ...
        list_participants_response_200.additional_properties = d
        return list_participants_response_200
