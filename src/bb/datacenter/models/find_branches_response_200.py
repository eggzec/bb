...
T = TypeVar("T", bound="FindBranchesResponse200")


@_attrs_define
class FindBranchesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_branches_response_200 = cls(
        ...
        find_branches_response_200.additional_properties = d
        return find_branches_response_200
