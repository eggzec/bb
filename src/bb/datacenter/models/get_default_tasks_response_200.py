...
T = TypeVar("T", bound="GetDefaultTasksResponse200")


@_attrs_define
class GetDefaultTasksResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_default_tasks_response_200 = cls(
        ...
        get_default_tasks_response_200.additional_properties = d
        return get_default_tasks_response_200
