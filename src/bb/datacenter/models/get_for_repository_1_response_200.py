...
T = TypeVar("T", bound="GetForRepository1Response200")


@_attrs_define
class GetForRepository1Response200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_for_repository_1_response_200 = cls(
        ...
        get_for_repository_1_response_200.additional_properties = d
        return get_for_repository_1_response_200
