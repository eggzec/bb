...
from ..models.rest_comment_anchor_pull_request_state import RestCommentAnchorPullRequestState
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rest_comment_anchor_pull_request_author import RestCommentAnchorPullRequestAuthor
    from ..models.rest_comment_anchor_pull_request_from_ref import RestCommentAnchorPullRequestFromRef
    from ..models.rest_comment_anchor_pull_request_links import RestCommentAnchorPullRequestLinks
    from ..models.rest_comment_anchor_pull_request_to_ref import RestCommentAnchorPullRequestToRef
    from ..models.rest_pull_request_participant import RestPullRequestParticipant


T = TypeVar("T", bound="RestCommentAnchorPullRequest")


@_attrs_define
class RestCommentAnchorPullRequest:
    author: RestCommentAnchorPullRequestAuthor | Unset = UNSET
    ...
    from_ref: RestCommentAnchorPullRequestFromRef | Unset = UNSET
    html_description: str | Unset = UNSET
    id: int | Unset = UNSET
    links: RestCommentAnchorPullRequestLinks | Unset = UNSET
    ...
    state: RestCommentAnchorPullRequestState | Unset = UNSET
    title: str | Unset = UNSET
    to_ref: RestCommentAnchorPullRequestToRef | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        author: RestCommentAnchorPullRequestAuthor | Unset
        if isinstance(_author, Unset):
            author = UNSET
        else:
            author = RestCommentAnchorPullRequestAuthor.from_dict(_author)
        ...
        from_ref: RestCommentAnchorPullRequestFromRef | Unset
        if isinstance(_from_ref, Unset):
            from_ref = UNSET
        else:
            from_ref = RestCommentAnchorPullRequestFromRef.from_dict(_from_ref)
        ...
        links: RestCommentAnchorPullRequestLinks | Unset
        if isinstance(_links, Unset):
            links = UNSET
        else:
            links = RestCommentAnchorPullRequestLinks.from_dict(_links)
        ...
        state: RestCommentAnchorPullRequestState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = RestCommentAnchorPullRequestState(_state)

        title = d.pop("title", UNSET)

        _to_ref = d.pop("toRef", UNSET)
        to_ref: RestCommentAnchorPullRequestToRef | Unset
        if isinstance(_to_ref, Unset):
            to_ref = UNSET
        else:
            to_ref = RestCommentAnchorPullRequestToRef.from_dict(_to_ref)

        updated_date = d.pop("updatedDate", UNSET)

        version = d.pop("version", UNSET)

        rest_comment_anchor_pull_request = cls(
            author=author,
            closed=closed,
        ...
        rest_comment_anchor_pull_request.additional_properties = d
        return rest_comment_anchor_pull_request
