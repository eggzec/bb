...
T = TypeVar("T", bound="GetPullRequestsResponse200")


@_attrs_define
class GetPullRequestsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pull_requests_response_200 = cls(
        ...
        get_pull_requests_response_200.additional_properties = d
        return get_pull_requests_response_200
