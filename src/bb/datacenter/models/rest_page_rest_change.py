...
if TYPE_CHECKING:
    from ..models.rest_page_rest_change_values import RestPageRestChangeValues


T = TypeVar("T", bound="RestPageRestChange")


@_attrs_define
class RestPageRestChange:
    is_last_page: bool | Unset = UNSET
    limit: int | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: int | Unset = UNSET
    start: int | Unset = UNSET
    values: RestPageRestChangeValues | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        values: RestPageRestChangeValues | Unset
        if isinstance(_values, Unset):
            values = UNSET
        else:
            values = RestPageRestChangeValues.from_dict(_values)

        rest_page_rest_change = cls(
        ...
        rest_page_rest_change.additional_properties = d
        return rest_page_rest_change
