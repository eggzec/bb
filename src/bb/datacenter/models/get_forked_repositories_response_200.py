...
T = TypeVar("T", bound="GetForkedRepositoriesResponse200")


@_attrs_define
class GetForkedRepositoriesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_forked_repositories_response_200 = cls(
        ...
        get_forked_repositories_response_200.additional_properties = d
        return get_forked_repositories_response_200
