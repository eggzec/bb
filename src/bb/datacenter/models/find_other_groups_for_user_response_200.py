...
T = TypeVar("T", bound="FindOtherGroupsForUserResponse200")


@_attrs_define
class FindOtherGroupsForUserResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_other_groups_for_user_response_200 = cls(
        ...
        find_other_groups_for_user_response_200.additional_properties = d
        return find_other_groups_for_user_response_200
