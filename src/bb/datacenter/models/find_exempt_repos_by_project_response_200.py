...
T = TypeVar("T", bound="FindExemptReposByProjectResponse200")


@_attrs_define
class FindExemptReposByProjectResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_exempt_repos_by_project_response_200 = cls(
        ...
        find_exempt_repos_by_project_response_200.additional_properties = d
        return find_exempt_repos_by_project_response_200
