...
T = TypeVar("T", bound="GetImportJobMessagesResponse200")


@_attrs_define
class GetImportJobMessagesResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_import_job_messages_response_200 = cls(
        ...
        get_import_job_messages_response_200.additional_properties = d
        return get_import_job_messages_response_200
