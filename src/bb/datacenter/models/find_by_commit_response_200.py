...
T = TypeVar("T", bound="FindByCommitResponse200")


@_attrs_define
class FindByCommitResponse200:
    is_last_page: bool | Unset = UNSET
    limit: float | Unset = UNSET
    next_page_start: int | Unset = UNSET
    size: float | Unset = UNSET
    start: int | Unset = UNSET
    values: list[RestMinimalRef] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                values_item = RestMinimalRef.from_dict(values_item_data)

                values.append(values_item)

        find_by_commit_response_200 = cls(
        ...
        find_by_commit_response_200.additional_properties = d
        return find_by_commit_response_200
