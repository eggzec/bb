...
T = TypeVar("T", bound="FindUsersInGroupResponse200")


@_attrs_define
class FindUsersInGroupResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        find_users_in_group_response_200 = cls(
        ...
        find_users_in_group_response_200.additional_properties = d
        return find_users_in_group_response_200
