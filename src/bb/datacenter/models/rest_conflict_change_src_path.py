...
T = TypeVar("T", bound="RestConflictChangeSrcPath")


@_attrs_define
class RestConflictChangeSrcPath:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_conflict_change_src_path = cls(
        ...
        rest_conflict_change_src_path.additional_properties = d
        return rest_conflict_change_src_path
