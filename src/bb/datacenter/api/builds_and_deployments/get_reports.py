...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/insights/latest/projects/{project_key}/repos/{repository_slug}/commits/{commit_id}/reports".format(
...
) -> GetReportsResponse200 | GetReportsResponse401 | GetReportsResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetReportsResponse200 | GetReportsResponse401 | GetReportsResponse404]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetReportsResponse200 | GetReportsResponse401 | GetReportsResponse404
    """
