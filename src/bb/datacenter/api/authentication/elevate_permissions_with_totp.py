...
from ...models.elevate_permissions_with_totp_action_type import ElevatePermissionsWithTotpActionType
...
def _get_kwargs(
    *,
    ...
    action_type: ElevatePermissionsWithTotpActionType | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Create elevated session with TOTP
     ...
     Elevate permissions by providing a TOTP code for the currently authenticated user. This will create
    an elevated session.

    Args:
        action_type (ElevatePermissionsWithTotpActionType | Unset):
