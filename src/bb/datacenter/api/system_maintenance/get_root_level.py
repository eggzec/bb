...
from ...models.get_root_level_response_401 import GetRootLevelResponse401
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> GetRootLevelResponse401 | RestLogLevel | None:
    ...
    if response.status_code == 401:
        response_401 = GetRootLevelResponse401.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetRootLevelResponse401 | RestLogLevel]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        GetRootLevelResponse401 | RestLogLevel
    """
