...
from ...models.stream_readme_response_401 import StreamReadmeResponse401
from ...models.stream_readme_response_404 import StreamReadmeResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/latest/projects/{project_key}/repos/{repository_slug}/readme".format(
...
) -> StreamReadmeResponse401 | StreamReadmeResponse404 | str | None:
    if response.status_code == 200:
        response_200 = response.text
        return response_200

    if response.status_code == 401:
        response_401 = StreamReadmeResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = StreamReadmeResponse404.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[StreamReadmeResponse401 | StreamReadmeResponse404 | str]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Note that, when streaming HTML, relative URLs in the README will not work if applied relative to
    this URL.
...
def sync(
    ...
    *,
    ...
    Returns:
        StreamReadmeResponse401 | StreamReadmeResponse404 | str
    """
