...
from ...models.delete_project_response_409 import DeleteProjectResponse409
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | DeleteProjectResponse401 | DeleteProjectResponse404 | DeleteProjectResponse409 | None:
    ...
    if response.status_code == 409:
        response_409 = DeleteProjectResponse409.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DeleteProjectResponse401 | DeleteProjectResponse404 | DeleteProjectResponse409]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | DeleteProjectResponse401 | DeleteProjectResponse404 | DeleteProjectResponse409
    """
