...
) -> GetProjectResponse401 | GetProjectResponse404 | RestProject | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetProjectResponse401 | GetProjectResponse404 | RestProject]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetProjectResponse401 | GetProjectResponse404 | RestProject
    """
