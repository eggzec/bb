...
from ...models.get_comment_2_response_401 import GetComment2Response401
from ...models.get_comment_2_response_404 import GetComment2Response404
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> GetComment2Response401 | GetComment2Response404 | RestComment | None:
    ...
    if response.status_code == 401:
        response_401 = GetComment2Response401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = GetComment2Response404.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetComment2Response401 | GetComment2Response404 | RestComment]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetComment2Response401 | GetComment2Response404 | RestComment
    """
