...
from ...models.update_comment_1_response_400 import UpdateComment1Response400
from ...models.update_comment_1_response_401 import UpdateComment1Response401
from ...models.update_comment_1_response_404 import UpdateComment1Response404
from ...models.update_comment_1_response_409 import UpdateComment1Response409
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = UpdateComment1Response400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = UpdateComment1Response401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = UpdateComment1Response404.from_dict(response.json())

        return response_404

    if response.status_code == 409:
        response_409 = UpdateComment1Response409.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[RestComment | UpdateComment1Response400 | UpdateComment1Response401 | UpdateComment1Response404 | UpdateComment1Response409]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        RestComment | UpdateComment1Response400 | UpdateComment1Response401 | UpdateComment1Response404 | UpdateComment1Response409
    """
