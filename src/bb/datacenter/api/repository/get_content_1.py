...
from ...models.get_content_1_response_400 import GetContent1Response400
from ...models.get_content_1_response_401 import GetContent1Response401
from ...models.get_content_1_response_404 import GetContent1Response404
...
) -> Any | GetContent1Response400 | GetContent1Response401 | GetContent1Response404 | None:
    if response.status_code == 200:
        response_200 = cast(Any, None)
        return response_200

    if response.status_code == 400:
        response_400 = GetContent1Response400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = GetContent1Response401.from_dict(response.json())

        return response_401

    if response.status_code == 404:
        response_404 = GetContent1Response404.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GetContent1Response400 | GetContent1Response401 | GetContent1Response404]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | GetContent1Response400 | GetContent1Response401 | GetContent1Response404
    """
