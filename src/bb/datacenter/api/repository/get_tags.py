...
) -> GetTagsResponse200 | GetTagsResponse401 | GetTagsResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetTagsResponse200 | GetTagsResponse401 | GetTagsResponse404]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetTagsResponse200 | GetTagsResponse401 | GetTagsResponse404
    """
