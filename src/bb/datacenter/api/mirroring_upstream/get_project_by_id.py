...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mirroring/latest/projects/{project_id}".format(
...
) -> GetProjectByIdResponse404 | RestProject | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetProjectByIdResponse404 | RestProject]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        GetProjectByIdResponse404 | RestProject
    """
